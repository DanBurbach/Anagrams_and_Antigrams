...
describe '#anagram_filter' do
  context "when called on anagrams" do
    it "should return: These words are anagrams" do
      input_words = Anagram.new("cat", "tac")
...
#    it "should return: These words are antigrams" do
#      input_words = Anagram.new("cat", "dog")
#    expect(input_words.anagram_filter).to eql "These words are antigrams"
#  end
#end
#
#describe '#anagram_filter'
...
#      input_words = Anagram.new("grt", "h3ll0")
...
#      input_words = Anagram.new("Clint Eastwood!", "Old West Action!!")
